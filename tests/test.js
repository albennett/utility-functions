...
it('truthyness', function(){  //it.only runs only that one test
  expect(true).to.be.true;
  });
});

it('array have length', function(doneYo){
  var array = [1,2,3];
  setTimeout(function(){
...
describe('helloWorld', function(){ //x ignores a test
